...
public class Evaluator implements EvaluatorConstants {
  ...
  static final public int S() throws ParseException {int sum;
    sum = E();
    jj_consume_token(0);
{if ("" != null) return sum;}
  ...
  static final public int E() throws ParseException {int sum, x;
    sum = T();
    label_1:
    while (true) {
...
{if ("" != null) return sum;}
  ...
  static final public int T() throws ParseException {int sum, x;
    sum = F();
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return sum;}
  ...
  static final public int F() throws ParseException {int x; Token n;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NUM:{
