...
public class Parser implements ParserConstants {
  ...
  static final public Exp S() throws ParseException {Exp e;
    e = E();
    jj_consume_token(0);
{if ("" != null) return e;}
  ...
  static final public Exp E() throws ParseException {Exp e1; Exp e2;
    e1 = T();
    label_1:
    while (true) {
...
{if ("" != null) return e1;}
  ...
  static final public Exp T() throws ParseException {Exp e1; Exp e2;
    e1 = F();
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return e1;}
  ...
  static final public Exp F() throws ParseException {Exp e; Token n;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NUM:{
      n = jj_consume_token(NUM);
{if ("" != null) return new Num(Integer.parseInt(n.image));}
      break;
      }
    case 5:{
      jj_consume_token(5);
